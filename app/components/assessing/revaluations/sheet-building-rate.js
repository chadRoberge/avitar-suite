...
export default class AssessingRevaluationsSheetBuildingRateComponent extends Component {
  // Args:
  ...
  get baseYear() {
    return this.args.globalSettings?.base_year || new Date().getFullYear();
  }
  ...
  get buildableSiteValue() {
    const value = this.settings.buildable_site_value || 290000;
    console.log('Component buildableSiteValue getter:', value);
    console.log('Full sheet_settings:', this.settings);
    return value;
  }
