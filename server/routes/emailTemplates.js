 ...
 */
router.get('/municipalities/:municipalityId/email-templates', authenticateToken, async (req, res) => {
  try {
    ...
    const templates = await MunicipalityEmailTemplate.find(query)
 ...
 */
router.get('/municipalities/:municipalityId/email-templates/:templateId', authenticateToken, async (req, res) => {
  try {
 ...
 */
router.post('/municipalities/:municipalityId/email-templates', authenticateToken, async (req, res) => {
  try {
    const { municipalityId } = req.params;
    ...
    const availableVariables = MunicipalityEmailTemplate.getAvailableVariables(template_type);
 ...
 */
router.patch('/municipalities/:municipalityId/email-templates/:templateId', authenticateToken, async (req, res) => {
  try {
    const { municipalityId, templateId } = req.params;
 ...
 */
router.delete('/municipalities/:municipalityId/email-templates/:templateId', authenticateToken, async (req, res) => {
  try {
    const { municipalityId, templateId } = req.params;
 ...
 */
router.post('/municipalities/:municipalityId/email-templates/preview', authenticateToken, async (req, res) => {
  try {
    const { municipalityId } = req.params;
 ...
 */
router.get('/email-templates/variables/:templateType', authenticateToken, async (req, res) => {
  try {
    const { templateType } = req.params;

    const variables = MunicipalityEmailTemplate.getAvailableVariables(templateType);
